...
<AnimatedSection delay={0.3} className="flex items-center justify-center">
  ...
  >
    {/* Ambient glow — scoped to card, outside overflow-hidden */}
    ...
    {/* Outer border glow — rendered outside the clipping container */}
    <div className="absolute -inset-[1px] rounded-2xl bg-gradient-to-br from-[var(--accent-light)]/30 via-transparent to-[var(--accent)]/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl" />
          ...
          <AnimatedSection delay={0.2}>
            <div className="space-y-5 mb-10">
              <p className="text-base text-[var(--text-secondary)] leading-[2]">
                ...
                , a cybersecurity enthusiast and ethical hacker based in{" "}
                <strong className="text-[var(--text-primary)] font-semibold">
                  Lagos, Nigeria
                </strong>
                . I&apos;m passionate about understanding how systems work — and
                how they break.
              </p>
              <p className="text-base text-[var(--text-secondary)] leading-[2]">
                I specialize in{" "}
                ...
                , network security, and security awareness. When I&apos;m not
                doing CTFs, I&apos;m building tools, writing about security, or
                setting up lab environments on Kali Linux.
              </p>
              <p className="text-base text-[var(--text-secondary)] leading-[2]">
                Currently sharpening my skills and working towards professional
