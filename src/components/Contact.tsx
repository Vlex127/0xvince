              ...
              {contactLinks.map((link) => {
                ...
                return (
                  <motion.a
                    ...
                    className="group flex items-center gap-3.5 font-[family-name:var(--font-mono)] text-[12px] text-[var(--text-tertiary)] no-underline px-3.5 py-2.5 rounded-lg transition-all duration-300"
                    style={{
